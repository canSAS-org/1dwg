...
FUNCTION CS_1i_collectMetadata(fileID, sasEntryPath)
	...
	FOR (i = 0; i < numpnts(SAScollimationList); i += 1)
		...
		CS_appendMetaData("collimation_length"+suffix, 	collimationPath+CS_XPath_NS("/length"), "")
		CS_appendMetaData("collimation_length_unit"+suffix, 	collimationPath+CS_XPath_NS("/length/@unit"), "")
