...
reduced small-angle scattering data.  It is a text format and is based on XML.
...
data analysis software. The canSAS (http://www.smallangles.net/canSAS) identified that a 
