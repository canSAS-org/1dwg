...
<!-- DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd" -->
				...
				<tr>
					...
					<td valign="top">
						<table border="2">
							...
							<!-- Here is one way to show ILL metadata, name each one specifically -->
							<tr>
								<td>Run extension</td>
								<td><xsl:value-of select="ill:Run_extension" /></td>
								<td />
							</tr>
							<tr>
								<td>Source_file</td>
								<td><xsl:value-of select="ill:Source_file" /></td>
								<td />
							</tr>
							<tr>
								<td>Flux_monitor</td>
								<td><xsl:value-of select="ill:Flux_monitor" /></td>
								<td />
							</tr>
							<tr>
								<td>Count_time_secs</td>
								<td><xsl:value-of select="ill:Count_time_secs" /></td>
								<td>s <!-- we know this to be seconds (s) --></td>
							</tr>
							<tr>
								<td>Q_resolution</td>
								<td><xsl:value-of select="ill:Q_resolution" /></td>
								<td />
							</tr>
							<!-- generic way to show ILL metadata, select each and all of them -->
							<xsl:apply-templates  select="ill:*" />
	...
	<xsl:template match="ill:*">
		<!-- generic way to show ILL metadata, show each of them in the metadata table -->
		<tr>
